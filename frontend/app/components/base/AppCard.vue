<template>
  <article class="flex flex-col gap-6 h-full">
   ...
   <div v-if="content" v-html="htmlContent" class="h-full px-6 py-7 text-base md:text-base bg-white border-2 border-brown-300 rounded-2xl" />
  </article>
</template>
<script setup>
