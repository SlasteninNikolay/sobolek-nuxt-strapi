...
<template>
  <section v-reveal class="relative pt-16 pb-14 lg:pb-0 lg:pt-28 bg-beige-500 overflow-hidden">
    <object class="hidden lg:block absolute top-0 left-1/2 -translate-x-1/2 w-auto h-auto z-0" type="image/svg+xml" data="/images/svg/route-4.svg"></object>
    <div class="container">
      ...
      <div v-reveal="{ variant: 'zoom', delay: 200 }" class="h-full">
        <base-app-gallery :photos="gallery" />
      </div>
    </div>
  </section>
</template>
